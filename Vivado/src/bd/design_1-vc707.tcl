...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_0
  ...
  set_property -dict [ list CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.SupportLevel {0} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_1
  ...
  set_property -dict [ list CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.SupportLevel {0} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_2
  ...
  set_property -dict [ list CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.SupportLevel {0} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_3
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins axi_ethernet_2/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins axi_ethernet_3/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
