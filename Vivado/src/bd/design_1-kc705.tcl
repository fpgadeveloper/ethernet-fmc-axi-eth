...
set_property -dict [list CONFIG.NUM_PORTS {21}] [get_bd_cells microblaze_0_xlconcat]
...
connect_bd_net [get_bd_pins axi_ethernetlite/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In20]
