...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {Custom} CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_0
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {Custom} CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.SupportLevel {0} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_1
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {Custom} CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.SupportLevel {0} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_2
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {Custom} CONFIG.MDIO_BOARD_INTERFACE {Custom} CONFIG.PHYRST_BOARD_INTERFACE {Custom} CONFIG.PHY_TYPE {RGMII} CONFIG.SupportLevel {0} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_3
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {114.829} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200} CONFIG.MMCM_CLKOUT0_DIVIDE_F {5.000} CONFIG.PRIM_SOURCE {No_buffer}  ] $clk_wiz_0
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins axi_ethernet_1/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins axi_ethernet_1_dma/S_AXI_LITE] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins axi_ethernet_2/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins axi_ethernet_2_dma/S_AXI_LITE] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins axi_ethernet_3/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_reset [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_mig_7series_0_100M/peripheral_reset]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_1_dma/Data_SG] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_1_dma/Data_MM2S] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_1_dma/Data_S2MM] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_2_dma/Data_SG] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_2_dma/Data_MM2S] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_2_dma/Data_S2MM] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_3_dma/Data_SG] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_3_dma/Data_MM2S] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ethernet_3_dma/Data_S2MM] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
