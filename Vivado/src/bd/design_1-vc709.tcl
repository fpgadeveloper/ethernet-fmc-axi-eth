...
endgroup
apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "8KB" ecc "None" cache "8KB" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/mig_7series_0/ui_addn_clk_0 (100 MHz)" }  [get_bd_cells microblaze_0]
...
startgroup
set_property -dict [list CONFIG.NUM_PORTS {16}] [get_bd_cells microblaze_0_xlconcat]
endgroup
...
delete_bd_objs [get_bd_nets axi_ethernet_0_gtxclk_locked] [get_bd_cells axi_ethernet_0_gtxclk]
...
endgroup
connect_bd_net -net [get_bd_nets axi_ethernet_0_gtxclk_clk_out1] [get_bd_pins util_ds_buf_0/IBUF_OUT]
...
# Connect external reset to GTX Processor System Reset block
