...
apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "64KB" ecc "None" cache "16KB" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/mig_0/ui_addn_clk_0 (100 MHz)" }  [get_bd_cells microblaze_0]
...
# Clock wizard to generate 125MHz and 200MHz from LPC Ethernet FMC reference clock
...
# Processor system reset for 125MHz clock for LPC
...
# Clock wizard to generate 125MHz and 200MHz from HPC Ethernet FMC reference clock
...
# Processor system reset for 125MHz clock for HPC
...
connect_bd_net [get_bd_ports reset] [get_bd_pins rst_clk_wiz_1_125M/ext_reset_in]
...
set_property -dict [list CONFIG.NUM_PORTS {26}] [get_bd_cells microblaze_0_xlconcat]
...
# Connect first Ethernet FMC 125MHz clock
...
# Connect second Ethernet FMC 125MHz clock
...
set_property -dict [list CONFIG.SupportLevel {1}] [get_bd_cells axi_ethernet_4]
...
connect_bd_net [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_1/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_2/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_3/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_4/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_5/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_6/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_7/s_axi_lite_clk] [get_bd_pins mig_0/ui_clk]

connect_bd_net [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_2/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_3/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_4/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_5/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_6/axis_clk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_7/axis_clk] [get_bd_pins mig_0/ui_clk]

connect_bd_net [get_bd_pins axi_ethernet_0_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_1_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_2_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_3_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_4_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_5_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_6_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_7_dma/s_axi_lite_aclk] [get_bd_pins mig_0/ui_clk]

connect_bd_net [get_bd_pins axi_ethernet_0_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_1_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_2_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_3_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_4_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_5_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_6_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_7_dma/m_axi_sg_aclk] [get_bd_pins mig_0/ui_clk]

connect_bd_net [get_bd_pins axi_ethernet_0_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_1_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_2_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_3_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_4_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_5_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_6_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_7_dma/m_axi_mm2s_aclk] [get_bd_pins mig_0/ui_clk]

connect_bd_net [get_bd_pins axi_ethernet_0_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_1_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_2_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_3_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_4_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_5_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_6_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_ethernet_7_dma/m_axi_s2mm_aclk] [get_bd_pins mig_0/ui_clk]
...
connect_bd_net [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_2/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_3/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_4/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_5/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_6/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_7/s_axi_lite_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_0_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_1_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_2_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_3_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_4_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_5_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_6_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_ethernet_7_dma/axi_resetn] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
...
connect_bd_net [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S05_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S06_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S07_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S08_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S09_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S10_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S11_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S12_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S13_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S14_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S15_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S05_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S06_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S07_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S08_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S09_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S10_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S11_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S12_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S13_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S14_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon/S15_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/M00_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/M00_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/ARESETN] [get_bd_pins rst_mig_0_200M/interconnect_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S00_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S01_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S02_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S03_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S04_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S05_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S06_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S07_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S08_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S09_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S10_ARESETN] [get_bd_pins rst_mig_0_200M/peripheral_aresetn]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S00_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S01_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S02_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S03_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S04_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S05_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S06_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S07_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S08_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S09_ACLK] [get_bd_pins mig_0/ui_clk]
connect_bd_net [get_bd_pins axi_mem_intercon_0/S10_ACLK] [get_bd_pins mig_0/ui_clk]
...
connect_bd_net [get_bd_pins axi_uart16550_0/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In24]
...
connect_bd_net [get_bd_pins axi_timer_0/interrupt] [get_bd_pins microblaze_0_xlconcat/In25]

# Add AXI EMC (linear flash) for PetaLinux

create_bd_cell -type ip -vlnv xilinx.com:ip:axi_emc axi_emc_0
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/mig_0/ui_addn_clk_0 (100 MHz)} Clk_slave {/mig_0/ui_addn_clk_0 (100 MHz)} Clk_xbar {/mig_0/ui_addn_clk_0 (100 MHz)} Master {/microblaze_0 (Periph)} Slave {/axi_emc_0/S_AXI_MEM} intc_ip {/microblaze_0_axi_periph} master_apm {0}}  [get_bd_intf_pins axi_emc_0/S_AXI_MEM]
...
CONFIG.S13_HAS_REGSLICE {4} \
CONFIG.S14_HAS_REGSLICE {4} \
CONFIG.S15_HAS_REGSLICE {4}] [get_bd_cells axi_mem_intercon]
...
CONFIG.S08_HAS_REGSLICE {4} \
CONFIG.S09_HAS_REGSLICE {4} \
CONFIG.S10_HAS_REGSLICE {4}] [get_bd_cells axi_mem_intercon_0]
