# These constraints are suitable for VCU118 ES1 (engineering sample silicon)
# --------------------------------------------------------------------------
# These constraints are for the vcu118-es1-axieth design which
...
set_property PACKAGE_PIN BC9 [get_ports ref_clk_p]
set_property PACKAGE_PIN BC8 [get_ports ref_clk_n]
