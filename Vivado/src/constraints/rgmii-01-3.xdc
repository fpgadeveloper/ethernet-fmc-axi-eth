...
set_input_delay -clock [get_clocks *axi_ethernet_0/inst/mac/inst_rgmii_rx_clk] -max -1.400 [get_ports -of [get_nets -of [get_pins {{*/axi_ethernet_0/rgmii_rd[*]} */axi_ethernet_0/rgmii_rx_ctl}]]]
...
set_input_delay -clock [get_clocks *axi_ethernet_0/inst/mac/inst_rgmii_rx_clk] -clock_fall -max -add_delay -1.400 [get_ports -of [get_nets -of [get_pins {{*/axi_ethernet_0/rgmii_rd[*]} */axi_ethernet_0/rgmii_rx_ctl}]]]
...
set_input_delay -clock [get_clocks *axi_ethernet_1/inst/mac/inst_rgmii_rx_clk] -max -1.400 [get_ports -of [get_nets -of [get_pins {{*/axi_ethernet_1/rgmii_rd[*]} */axi_ethernet_1/rgmii_rx_ctl}]]]
...
set_input_delay -clock [get_clocks *axi_ethernet_1/inst/mac/inst_rgmii_rx_clk] -clock_fall -max -add_delay -1.400 [get_ports -of [get_nets -of [get_pins {{*/axi_ethernet_1/rgmii_rd[*]} */axi_ethernet_1/rgmii_rx_ctl}]]]
...
set_input_delay -clock [get_clocks *axi_ethernet_3/inst/mac/inst_rgmii_rx_clk] -max -1.400 [get_ports -of [get_nets -of [get_pins {{*/axi_ethernet_3/rgmii_rd[*]} */axi_ethernet_3/rgmii_rx_ctl}]]]
...
set_input_delay -clock [get_clocks *axi_ethernet_3/inst/mac/inst_rgmii_rx_clk] -clock_fall -max -add_delay -1.400 [get_ports -of [get_nets -of [get_pins {{*/axi_ethernet_3/rgmii_rd[*]} */axi_ethernet_3/rgmii_rx_ctl}]]]
