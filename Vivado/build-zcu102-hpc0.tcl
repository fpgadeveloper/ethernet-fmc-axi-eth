...
# Create project
create_project $design_name $origin_dir/$design_name -part xczu9eg-ffvb1156-2-i-es2
...
set_property "board_part" "xilinx.com:zcu102:part0:2.0" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xczu9eg-ffvb1156-2-i-es2 -flow {Vivado Synthesis 2016} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xczu9eg-ffvb1156-2-i-es2 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
