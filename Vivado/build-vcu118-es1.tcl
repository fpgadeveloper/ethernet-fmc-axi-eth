...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xcvu9p-flga2104-2L-e-es1 -flow {Vivado Implementation 2017} -strategy "Performance_Explore" -constrset constrs_1 -parent_run synth_1
} else {
