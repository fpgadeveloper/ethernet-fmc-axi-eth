#
# build.tcl: Tcl script for re-creating project 'zedboard_axieth'
#
#*****************************************************************************************
...
set design_name zedboard_axieth
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z020clg484-1 -flow {Vivado Implementation 2018} -strategy "Performance_Explore" -constrset constrs_1 -parent_run synth_1
} else {
