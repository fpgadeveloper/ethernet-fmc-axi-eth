#
# build.tcl: Tcl script for re-creating project 'vcu108_hpc0_axieth'
#
#*****************************************************************************************
...
set design_name vcu108_hpc0_axieth
...
# Create project
create_project $design_name $origin_dir/$design_name -part xcvu095-ffva2104-2-e
...
set_property -name "board_part" -value "xilinx.com:vcu108:part0:1.7" -objects $obj
...
set file "[file normalize "$origin_dir/src/constraints/vcu108-hpc0.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/vcu108-hpc0.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/vcu108-hpc0.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvu095-ffva2104-2-e -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu095-ffva2104-2-e -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
