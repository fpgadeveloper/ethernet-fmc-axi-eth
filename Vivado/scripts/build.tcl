...
dict set target_dict kc705_lpc_hpc { xilinx.com kc705 mb-7s rgmii-01234567 { 0 1 2 3 4 5 6 7 } { 0 4 } }
...
dict set target_dict vc707_hpc2_hpc1 { xilinx.com vc707 mb-7s rgmii-01234567 { 0 1 2 3 4 5 6 7 } { 0 4 } }
...
dict set target_dict kcu105_dual { xilinx.com kcu105 mb-us rgmii-01-34567 { 0 1 3 4 5 6 7 } { 0 4 } }
...
dict set target_dict zc702_lpc2_lpc1 { xilinx.com zc702 zc702-dual rgmii-01234567 { 0 1 2 3 4 5 6 7 } { 0 4 } }
dict set target_dict zc706_lpc { xilinx.com zc706 zynq rgmii-0123 { 0 1 2 3 } { 0 } }
dict set target_dict zedboard { avnet.com zedboard zynq rgmii-0123 { 0 1 2 3 } { 1 } }
...
set shared_logic_ports [lindex [dict get $target_dict $target] 5]
